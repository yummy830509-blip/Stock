 ...
 try {
   ...
   const response = await fetch("https://api.anthropic.com/v1/messages", {
     ...
     body: JSON.stringify({
       ...
       max_tokens: 400,
       system: "你是股市預言機。根據提供的新聞標題預測今日三大市場走向，每個附上簡短理由，並附一句跟股市有關的名言，盡量不重複。只要台灣繁體中文。只回傳JSON不要其他文字：{\"taiwan\":{\"direction\":\"漲\",\"confidence\":\"高\",\"reason\":\"20字內理由\"},\"us\":{\"direction\":\"跌\",\"confidence\":\"中\",\"reason\":\"20字內理由\"},\"japan\":{\"direction\":\"平\",\"confidence\":\"低\",\"reason\":\"20字內理由\"},\"quote\":\"股神名言40字內\"} direction只能是漲跌平。",
